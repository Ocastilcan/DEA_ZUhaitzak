...
public class BZBAdabegia {
	...
	// ezabatuHostoTxikiagoak

	public void ezabatuHostoTxikiagoak(int e) {
		if (this.baduEskuina()) {
			if (this.ezkerra.hostoaDa()) {
				if (this.ezkerra.info < e) this.ezkerra = null;
			} else {this.ezkerra.ezabatuHostoTxikiagoak(e);}
		}
		if (this.baduEskuina()) {
			if (this.eskuina.hostoaDa()) {
				if (this.eskuina.info < e) this.eskuina = null;
			} else {this.eskuina.ezabatuHostoTxikiagoak(e);}
		}
